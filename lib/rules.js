...
function countScrapeMatches(t) {
  ...
  if (t.scrape_title && t.title && normCmp(t.title) === normCmp(t.scrape_title)) n++;
  if (t.scrape_artist && t.artist && normCmp(t.artist) === normCmp(t.scrape_artist)) n++;
  if (t.scrape_album && t.album && normCmp(t.album) === normCmp(t.scrape_album)) n++;
