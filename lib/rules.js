...
export const PICK_TAG_LABEL = {
  ...
  release_best: '发行更早', scrape_best: '刮削更准',  meta_best: '标签最全', manual_keep: '手动保留',
};
// PICK_TAG_LABEL 留在核心而非展示层（rules-ui.js）：evaluateGroup 的 TIER_DEFS
// 用它拼 _keepReason 文本，是级联输出的契约一部分。PICK_TAG_COLOR（纯展示）在 lib/rules-ui.js。
...
// ═══════════════════════════════════════════════════════════════════════════
// Thin wrappers for callers that want the standalone API
// ═══════════════════════════════════════════════════════════════════════════
