...
function initSchema(db) {
  ...
  // Migration: rename album_year_diff → release_year_diff in stored match_tags
  db.exec(`UPDATE dup_groups SET match_tags = REPLACE(match_tags, 'album_year_diff', 'release_year_diff') WHERE match_tags LIKE '%album_year_diff%'`);
