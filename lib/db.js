...
// 不依赖其他刮削器的状态。
// - smartScan=true, retryMissed=false（智能执行）：仅选取 mb_checked_at 为空或
//   文件修改时间晚于上次检查的文件
...
// - smartScan=true, retryMissed=false（智能执行）：仅选取 acoustid_checked_at 为空或
//   文件修改时间晚于上次检查的文件
